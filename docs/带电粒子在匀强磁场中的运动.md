...
$$
\hat{H} = \frac{1}{2\mu}((p_x^2+p_y^2+p_z^2) + \frac{1}{4}(eB)^2(x^2+y^2)-eBL_z)
$$

换到柱坐标系，

$$
\hat{H} = \frac{1}{2\mu}(-\hbar^2\nabla^2 + \frac{1}{4}(eB)^2(x^2+y^2)-eBL_z) \\
...
= \gamma^2D+2\gamma^2xD^2
$$

$$
\gamma^2D\chi +2\gamma^2xD^2 \chi + \gamma^2 D\chi + (\frac{2\mu\epsilon}{\hbar^2} - \frac{1}{2}x-\frac{m^2\gamma^2}{2x})\chi = 0
$$
